    ...
    <div class="modal fade" id="studentaddmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="campagency_insert.php" method="POST">
    ...
    <div class="modal fade" id="editmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="campagency_update.php" method="POST">

                    <div class="modal-body">

                        <input type="hidden" name="update_agency_id" id="update_agency_id">
    ...
    <div class="modal fade" id="deletemodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="campagency_delete.php" method="POST">

                    <div class="modal-body">

                        <input type="hidden" name="delete_agency_id" id="delete_agency_id">
    ...
    <div class="container">
        <div class="jumbotron">
            ...
            <div class="card">
                ...
                $query = "CALL read_campagency_data()";
