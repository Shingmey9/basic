    ...
    <div class="modal fade" id="studentaddmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="newrequests_insert.php" method="POST">
    ...
    <div class="modal fade" id="editmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="newrequests_update.php" method="POST">

                    <div class="modal-body">

                        <input type="hidden" name="update_req_id" id="update_req_id">
    ...
    <div class="modal fade" id="deletemodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="newrequests_delete.php" method="POST">

                    <div class="modal-body">

                        <input type="hidden" name="delete_req_id" id="delete_req_id">
    ...
    <div class="container">
        <div class="jumbotron">
            ...
            <div class="card">
                ...
                $query = "CALL read_newrequests_data()";
    ...
    <script>
        $(document).ready(function () {
            ...
            $('.editbtn').on('click', function () {
                ...
                $('#update_req_id').val(data[0]);
                $('#name').val(data[1]);
                $('#contact').val(data[2]);
                $('#blood_group').val(data[3]);
                $('#gender').val(data[4]);
