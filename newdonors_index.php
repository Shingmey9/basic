        ...
        <div class="jumbotron">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <a class="btn btn-outline-info" role="button" href="newdonors_card.php">View Details</a>
                </div>
            </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('.editbtn').on('click', function () {
                ...
                $('#update_newd_id').val(data[0]);
                $('#name').val(data[1]);
                $('#email').val(data[2]);
                $('#address').val(data[3]);
                $('#blood_group').val(data[4]);
                $('#gender').val(data[5]);
